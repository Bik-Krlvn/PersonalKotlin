...
import com.cheiseproj.bik_krl.personalkotlin.di.module.ViewModelModule
...
class RoomModule {
    ...
    fun provideAppDatabase(application: Application):AppDatabase{
        appDatabase = Room.databaseBuilder(application,AppDatabase::class.java, AppConstant.DATABASE_NAME)
